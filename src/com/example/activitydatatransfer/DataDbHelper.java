...
public class DataDbHelper extends SQLiteOpenHelper {
	...
	private static final String SQL_CREATE_ENTRIES =
	    "CREATE TABLE " + DataEntry.TABLE_NAME + " (" +
	    		...
	    		DataEntry.COLUMN_NAME_FIRST_NAME + TEXT_TYPE + COMMA_SEP +
	    		DataEntry.COLUMN_NAME_LAST_NAME +TEXT_TYPE + COMMA_SEP +
	    		DataEntry.COLUMN_NAME_ADDRESS +TEXT_TYPE + COMMA_SEP +
	    		DataEntry.COLUMN_NAME_CC_NUMBER +TEXT_TYPE +
	    		" )";
